...
//        userList.removeIf(user -> user.getRoles().stream().anyMatch(role -> role.getName().equals("ROLE_HR")));
    ...
    public String getNameUserByRole() {
        return String.valueOf(userRepository.findAllUserNamesByRoles());
    }
    public String getEmailUserRole(){
        return String.valueOf(userRepository.findAllUserEmailByRoles());
    }
}