    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("api/plans/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_TM")
                        .requestMatchers("api/recruitmentRequests/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_TM")
                        .requestMatchers("api/plansIntern/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_TM"    )
                        .requestMatchers("/api/recruitmentStats/**").hasAnyAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/dashboard/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_TM")
